...
# IMPORTANT: This material is a complement to the ITEC621Scripts.R code covered in the class. We may cover some of this material if time permits. But if not, the code provided here is well documented and some of it is complemented in the Goodies lecture slides. Hopefully these scripts and the corresponding slides will at least point you in the right direction
